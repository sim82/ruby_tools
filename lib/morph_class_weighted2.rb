...
wlines.each do |l|
	...
	# 		`sh ../../../../../morph_class_nobs_wgh.sh`
			`java -cp ~/workspace/java_tools/bin/ ml.RedTrees ../../../../RAxML_result.mol_GAMMA_1`

			Dir["RAxML_result.mol_GAMMA_1_????"].each do |f|
			...
			jout = `java -cp ~/workspace/java_tools/bin/ ml.ClassifierLTree --auto RAxML_result.mol_GAMMA_1.rn ../../../../RAxML_result.mol_GAMMA_1`
